...
export const appConfig: AppConfig = {
    ...
    pageInfo: {
        ...
        'zawgyi-unicode-converter-android': {
            title: 'Zawgyi Unicode Converter Android App - Myanmar Tools',
        ...
        'ng-translit': {
            title: 'DagonMetric/ng-translit - Myanmar Tools',
        ...
        'ng-zawgyi-detector': {
            title: 'myanmartools/ng-zawgyi-detector - Myanmar Tools',
        ...
        'zawgyi-unicode-translit-rules': {
            title: 'myanmartools/zawgyi-unicode-translit-rules - Myanmar Tools',
