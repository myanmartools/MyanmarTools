...
export const appConfig: AppConfig = {
    ...
    pageInfo: {
        ...
        'zawgyi-unicode-converter-android': {
            ...
            description: 'Zawgyi Unicode Converter is a free open source Zawgyi to Unicode or Unicode to Zawgyi Myanmar (Burmese) font converter android app created by DagonMetric Myanmar Tools.',
            keywords: 'zawgyi unicode converter,zawgyi unicode converter android,zawgyi,unicode converter,zawgyi to unicode,unicode to zawgyi,zawgyi unicode,burmese font converter,myanmar tools,dagonmetric',
        ...
        'unicode-code-points-lookup': {
            ...
            keywords: 'unicode code points lookup,unicode lookup,unicode code points,unicode converter,Unicode encode decode,myanmar tools,dagonmetric',
        ...
        'ng-translit': {
            ...
            keywords: 'ng translit,transliterate service,transliteration,transliterate,angular,zawgyi,unicode,myanmar tools,dagonmetric'
        },
        'ng-zawgyi-detector': {
        ...
        'zawgyi-unicode-translit-rules': {
            ...
            keywords: 'zawgyi unicode translit rules,zawgyi unicode convert rules,zawgyi unicode converter,transliterate rules,transliteration,transliterate,unicode,zawgyi,myanmartools,myanmar tools'
        },
        'not-found': {
